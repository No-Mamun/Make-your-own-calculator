...
document.write(name1 + "+" + name2 + "=" + Addition + "<br/>");

result = name1 - name2;

document.write(name1 + "-" + name2 + "=" + Subtraction + "<br/>");
result = name1 * name2;

document.write(name1 + "*" + name2 + "=" + Multiplication + "<br/>");
result = name1 / name2;

document.write(name1 + "/" + name2 + "=" + Division + "<br/>");
result= name1 % name2;

document.write(name1 + "%" + name2 + "=" + Remainder + "<br/>");
